	...
	if(NOT ${disable_annoying} EQUAL -1)
	  if(WMSVC)
	    # bounds-checked functions require to set __STDC_WANT_LIB_EXT1__ which we usually don't need/want
			...
			list(APPEND WarningDefinitions -D_SCL_SECURE_NO_WARNINGS)
	  ...
	  elseif(WCLANG)
		list(APPEND WarningFlags -Wno-unknown-warning-option -Wno-padded -Wno-undef -Wno-reserved-id-macro -Wno-documentation -Wno-documentation-unknown-command)
